...
class KMNISTClassifier(nn.Module):
    """Convolutional neural network for classifying KMNIST images"""
...
def prepare_data_loaders() -> tuple[DataLoader, DataLoader]:
    """Download KMNIST dataset and create PyTorch DataLoaders"""

    # Normalization values for KMNIST
    mean = (0.1918,)
    std = (0.3483,)
...
def train_neural_network(
    ...
    """Train and evaluate a neural network on the KMNIST dataset"""
    ...
    # Initialize model
    model = KMNISTClassifier(num_classes=len(class_names))
