...
class CIFAR10Classifier(nn.Module):
    """Convolutional neural network for classifying CIFAR10 images"""
    ...
    def describe(self) -> None:
        ...
        print("  Input: 32x32x3 (RGB images)")
...
def prepare_data_loaders() -> tuple[DataLoader, DataLoader]:
    """Download CIFAR10 dataset and create PyTorch DataLoaders"""
...
def train_neural_network(
    ...
    """Train and evaluate a neural network on the CIFAR10 dataset"""
    ...
    # Initialize model
    model = CIFAR10Classifier(num_classes=len(class_names))
